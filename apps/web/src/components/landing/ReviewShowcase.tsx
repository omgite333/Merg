...
const reviewStories = [
  {
    ...
    description: "A lightweight status note appears in the pull request while Merg reads the latest changes.",
    image: "/reviews/first.jpg",
    alt: "Merg review in progress on a GitHub pull request",
  },
  {
    number: "02",
    ...
    alt: "Merg summary with actionable pull request findings",
  },
  {
    number: "03",
    title: "A clear answer at the end.",
    description: "When the pass is clean, Merg leaves a concise merge-ready summary in the thread.",
    image: "/reviews/third.jpg",
    alt: "Merg merge-ready pull request summary",
  },
];
          ...
          {reviewStories.map((story, index) => (
            <article key={story.number} className={`${index > 0 ? "border-t border-[#eeeeeb] pt-20 sm:pt-24" : ""} ${index < reviewStories.length - 1 ? "pb-20 sm:pb-24" : ""}`}>
              <div className="mx-auto mb-9 max-w-[620px] text-center">
                <p className="mb-3 text-[12px] font-semibold uppercase tracking-[0.18em] text-[#737373]">{story.number} / Merg review</p>
