    ...
    <section id="byok" className="scroll-mt-20 border-y border-[#eeeeee] bg-[#fbfbfb]">
      <div className="mx-auto grid max-w-[1180px] gap-12 px-6 py-24 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:px-10 lg:py-32">
        <div>
          ...
          <p className="mt-6 max-w-[500px] text-[16px] leading-7 text-[#656565]">Route reviews through the model account you already use. Merg brings the workflow and context. You keep the key, the billing, and the control.</p>
