  ...
  return (
    <div className="max-w-4xl space-y-7">
      <section>
        ...
        <h1 className="mt-2 text-[32px] font-semibold leading-none tracking-[-0.06em] text-[#20201e] sm:text-[38px]">Your Merg connection.</h1>
      ...
      <section className="overflow-hidden rounded-2xl border border-[#e5e5e0] bg-white shadow-[0_8px_24px_rgba(23,23,23,0.035)]">
        <div className="border-b border-[#ecece7] px-5 py-4 sm:px-6"><h2 className="text-[15px] font-semibold tracking-[-0.025em]">Connected GitHub accounts</h2><p className="mt-1 text-[12px] text-[#83837d]">Merg can only review repositories granted through a GitHub App installation.</p></div>
