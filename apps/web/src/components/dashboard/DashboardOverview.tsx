    ...
    <div className="space-y-7">
      ...
      {workspace.installations.length === 0 ? (
        <EmptyPanel
          ...
          description="Install the Merg GitHub App, choose a repository, and every new pull request will enter the review pipeline automatically."
          action={
            <a href={GITHUB_APP_INSTALL_URL} target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 rounded-full bg-[#20201e] px-4 py-2.5 text-[12px] font-semibold text-white transition-colors hover:bg-[#343430]">
              Install on GitHub
        ...
        <>
          <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
            <MetricCard label="Active repositories" value={workspace.repositories.length} hint="Repositories currently connected to Merg" icon={<DashboardIcon icon={FolderGitIcon} size={18} aria-hidden="true" />} />
