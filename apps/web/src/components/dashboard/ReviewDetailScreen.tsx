  ...
  if (error && !data) {
    return (
      <EmptyPanel
        ...
        description={error === "REVIEW_NOT_FOUND" ? "The review is unavailable, or it no longer exists." : "Check that the Merg API is running, then try again."}
      ...
      <section className="rounded-2xl border border-[#e5e5e0] bg-white p-5 shadow-[0_8px_24px_rgba(23,23,23,0.035)] sm:p-7">
        ...
        {activeReview ? (
          <div className="mt-6 flex items-start gap-3 rounded-xl border border-[#cddcff] bg-[#f1f5ff] px-4 py-3 text-[13px] text-[#315baf]">
            ...
            <p>Merg is still reviewing this pull request. This page refreshes automatically every five seconds.</p>
          </div>
        ) : null}
