...
const toc = [
  ...
  { id: "how-it-works", label: "How Merg Works" },
    ...
    <div className="flex">
      ...
      <article className="min-w-0 flex-1 px-12 py-8 text-[13px] leading-relaxed">
        ...
        <p className="mb-6 text-[#888]">
          Merg is an AI-powered GitHub PR reviewer. Install it as a GitHub App,
        ...
        <p className="mb-4 text-[#888]">
          Merg connects to your GitHub repositories via a GitHub App and reviews
          pull requests automatically. When a PR is opened, Merg runs security,
        ...
        <p className="mb-3 text-[#888]">
          When a pull request is opened or updated, GitHub sends a webhook to Merg.
        ...
        <p className="mb-4 text-[#888]">
          ...
          on the PR diff via the Merg bot account.
        </p>

        <h2 id="installation" className="mb-3 mt-8 text-[18px] font-bold text-white scroll-mt-16">
          Installation
        </h2>
        <p className="mb-3 text-[#888]">Install the Merg GitHub App in three steps:</p>
        <ol className="mb-4 space-y-2 text-[#888]">
          {[
            "Visit the GitHub Marketplace and install the Merg GitHub App.",
            "Authorize Merg and select the repositories to review.",
            "Open a pull request — Merg will post a review automatically.",
          ].map((step, i) => (
        ...
        <div className="my-5 border border-white/8 bg-[#0f0d0d] px-5 py-4 text-[12px]">
          ...
          <br />
          <code className="text-[#81c995]">{GITHUB_APP_INSTALL_URL}</code>
        </div>
        ...
        <p className="mb-3 text-[#888]">
          Add a <code className="rounded border border-white/8 bg-[#1a1818] px-1.5 py-0.5">.merg.yml</code> file
